    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtn3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(ButtonActivity.this, "tv3被点击了", Toast.LENGTH_SHORT).show();
        ...
        luna = findViewById(R.id.btn_luna);
        luna.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(ButtonActivity.this, "luna被点击了", Toast.LENGTH_SHORT).show();
            }
        });
    }
